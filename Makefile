...
.PHONY: help dev-image dev-up dev-shell dev-down build-artifacts prod-image prod-up prod-down prod-logs localstack-up localstack-down localstack-logs localstack-tables clean-target compose-setup compose-build compose-up compose-down compose-restart compose-logs compose-health compose-clean
